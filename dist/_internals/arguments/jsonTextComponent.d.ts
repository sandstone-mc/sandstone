 ...
 */
declare type PossibleComponents = (string | boolean | number | TextComponentObject | ComponentClass);
export declare type JsonTextComponent = (readonly PossibleComponents[] | PossibleComponents);
export {};
