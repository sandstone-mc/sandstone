import { McFunctionName, CommandArgs } from './minecraft';
/**
 ...
 */
export declare function saveDatapack(functions: Map<McFunctionName, CommandArgs[]>, name: string, options: SaveOptions): void;
