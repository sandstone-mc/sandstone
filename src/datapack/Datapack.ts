...
export default class Datapack {
  ...
  CustomResource = <TYPE extends string, DATA_TYPE extends CustomResourceDataTypes>(type: TYPE, namespaced: boolean, properties: CustomResourceProperties<DATA_TYPE>) => new CustomResourceFactory(this, type, properties)
