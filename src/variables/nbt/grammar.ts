...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    { name: '__', symbols: ['__$ebnf$1'], postprocess(d) { return null } },
    { name: 'wschar', symbols: [/[ \t\n\v\f]/], postprocess: id },
    ...
    { name: 'dqstring', symbols: [{ literal: '"' }, 'dqstring$ebnf$1', { literal: '"' }], postprocess(d) { return d[1].join('') } },
    { name: 'sqstring$ebnf$1', symbols: [] },
    { name: 'sqstring$ebnf$1', symbols: ['sqstring$ebnf$1', 'sstrchar'], postprocess: (d) => d[0].concat([d[1]]) },
    { name: 'sqstring', symbols: [{ literal: "'" }, 'sqstring$ebnf$1', { literal: "'" }], postprocess(d) { return d[1].join('') } },
    { name: 'btstring$ebnf$1', symbols: [] },
    { name: 'btstring$ebnf$1', symbols: ['btstring$ebnf$1', /[^`]/], postprocess: (d) => d[0].concat([d[1]]) },
    { name: 'btstring', symbols: [{ literal: '`' }, 'btstring$ebnf$1', { literal: '`' }], postprocess(d) { return d[1].join('') } },
    ...
    { name: 'sstrchar', symbols: [{ literal: '\\' }, 'strescape'], postprocess(d) { return JSON.parse(`"${d.join('')}"`) } },
    { name: 'sstrchar$string$1', symbols: [{ literal: '\\' }, { literal: "'" }], postprocess: (d) => d.join('') },
    { name: 'sstrchar', symbols: ['sstrchar$string$1'], postprocess(d) { return "'" } },
    ...
    { name: 'expression', symbols: ['expression$subexpression$1'], postprocess: (data: NBTExpression[][]) => data[0][0] },
    { name: 'object', symbols: [{ literal: '{' }, 'objectInner', { literal: '}' }], postprocess: (data: any) => Object.fromEntries([...data[1].map(({ key, value }: {key: string, value: NBTExpression}) => [key, value]), [isCompoundSymbol, true]]) },
    ...
    { name: 'objectInner$ebnf$1', symbols: ['objectInner$ebnf$1', 'objectInner$ebnf$1$subexpression$1'], postprocess: (d) => d[0].concat([d[1]]) },
    ...
    { name: 'objectKeyValue$ebnf$1', symbols: ['objectKeyValue$ebnf$1', /[a-zA-Z]/], postprocess: (d) => d[0].concat([d[1]]) },
    { name: 'objectKeyValue', symbols: ['objectKeyValue$ebnf$1', '_', { literal: ':' }, '_', 'expression'], postprocess: (data) => ({ key: data[0].join(''), value: data[4] }) },
    { name: 'objectKeyValue', symbols: ['string', '_', { literal: ':' }, '_', 'expression'], postprocess: (data) => ({ key: data[0].value, value: data[4] }) },
    ...
    { name: 'array$macrocall$1$ebnf$1', symbols: ['array$macrocall$1$ebnf$1', 'array$macrocall$1$ebnf$1$subexpression$1'], postprocess: (d) => d[0].concat([d[1]]) },
    ...
    { name: 'array', symbols: [{ literal: '[' }, 'array$macrocall$1', { literal: ']' }], postprocess: (data) => data[1] },
    ...
    { name: 'byteArray$macrocall$1$ebnf$1$subexpression$1', symbols: ['byteArray$macrocall$2', '_', { literal: ',' }, '_'] },
    { name: 'byteArray$macrocall$1$ebnf$1', symbols: ['byteArray$macrocall$1$ebnf$1', 'byteArray$macrocall$1$ebnf$1$subexpression$1'], postprocess: (d) => d[0].concat([d[1]]) },
    { name: 'byteArray$macrocall$1$ebnf$2$subexpression$1', symbols: ['_', { literal: ',' }] },
    { name: 'byteArray$macrocall$1$ebnf$2', symbols: ['byteArray$macrocall$1$ebnf$2$subexpression$1'], postprocess: id },
    ...
    { name: 'byteArray', symbols: [{ literal: '[' }, '_', { literal: 'B' }, '_', { literal: ';' }, 'byteArray$macrocall$1', { literal: ']' }], postprocess: (data) => ({ dataType: 'byteArray', value: data[5] }) },
    ...
    { name: 'intArray$macrocall$1$ebnf$1$subexpression$1', symbols: ['intArray$macrocall$2', '_', { literal: ',' }, '_'] },
    { name: 'intArray$macrocall$1$ebnf$1', symbols: ['intArray$macrocall$1$ebnf$1', 'intArray$macrocall$1$ebnf$1$subexpression$1'], postprocess: (d) => d[0].concat([d[1]]) },
    ...
    { name: 'intArray', symbols: [{ literal: '[' }, '_', { literal: 'I' }, '_', { literal: ';' }, 'intArray$macrocall$1', { literal: ']' }], postprocess: (data) => ({ dataType: 'intArray', value: data[5] }) },
    ...
    { name: 'longArray$macrocall$1$ebnf$1$subexpression$1', symbols: ['longArray$macrocall$2', '_', { literal: ',' }, '_'] },
    { name: 'longArray$macrocall$1$ebnf$1', symbols: ['longArray$macrocall$1$ebnf$1', 'longArray$macrocall$1$ebnf$1$subexpression$1'], postprocess: (d) => d[0].concat([d[1]]) },
    { name: 'longArray$macrocall$1$ebnf$2$subexpression$1', symbols: ['_', { literal: ',' }] },
    { name: 'longArray$macrocall$1$ebnf$2', symbols: ['longArray$macrocall$1$ebnf$2$subexpression$1'], postprocess: id },
    ...
    { name: 'longArray', symbols: [{ literal: '[' }, '_', { literal: 'L' }, '_', { literal: ';' }, 'longArray$macrocall$1', { literal: ']' }], postprocess: (data) => ({ dataType: 'longArray', value: data[5] }) },
    { name: 'string$subexpression$1', symbols: ['dqstring'] },
    { name: 'string$subexpression$1', symbols: ['sqstring'] },
    { name: 'string', symbols: ['string$subexpression$1'], postprocess: (data) => ({ dataType: 'string', value: data[0][0] }) },
    ...
    { name: 'typedByte$subexpression$1', symbols: [/[bB]/], postprocess(d) { return d.join('') } },
    { name: 'typedByte', symbols: ['int', 'typedByte$subexpression$1'], postprocess: (data) => ({ dataType: 'byte', value: data[0] }) },
    { name: 'typedShort$subexpression$1', symbols: [/[sS]/], postprocess(d) { return d.join('') } },
    { name: 'typedShort', symbols: ['int', 'typedShort$subexpression$1'], postprocess: (data) => ({ dataType: 'short', value: data[0] }) },
    { name: 'typedLong$subexpression$1', symbols: [/[lL]/], postprocess(d) { return d.join('') } },
    { name: 'typedLong', symbols: ['int', 'typedLong$subexpression$1'], postprocess: (data) => ({ dataType: 'long', value: data[0] }) },
    { name: 'typedFloat$subexpression$1', symbols: [/[dD]/], postprocess(d) { return d.join('') } },
    { name: 'typedFloat', symbols: ['decimal', 'typedFloat$subexpression$1'], postprocess: (data) => ({ dataType: 'double', value: data[0] }) },
    { name: 'typedFloat$subexpression$2', symbols: [/[fF]/], postprocess(d) { return d.join('') } },
    { name: 'typedFloat', symbols: ['decimal', 'typedFloat$subexpression$2'], postprocess: (data) => ({ dataType: 'float', value: data[0] }) },
    { name: 'number$subexpression$1', symbols: ['decimal'] },
    { name: 'number', symbols: ['number$subexpression$1'], postprocess: (data) => ({ dataType: 'number', value: data[0][0] }) },
    { name: 'boolean$subexpression$1$string$1', symbols: [{ literal: 't' }, { literal: 'r' }, { literal: 'u' }, { literal: 'e' }], postprocess: (d) => d.join('') },
    { name: 'boolean$subexpression$1', symbols: ['boolean$subexpression$1$string$1'] },
    { name: 'boolean$subexpression$1$string$2', symbols: [{ literal: 'f' }, { literal: 'a' }, { literal: 'l' }, { literal: 's' }, { literal: 'e' }], postprocess: (d) => d.join('') },
    { name: 'boolean$subexpression$1', symbols: ['boolean$subexpression$1$string$2'] },
    { name: 'boolean', symbols: ['boolean$subexpression$1'], postprocess: (data) => ({ dataType: 'boolean', value: data[0].join('') === 'true' }) },
  ],
