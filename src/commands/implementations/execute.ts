...
export class ExecuteIfUnlessCommand extends ExecuteCommandPart {
   ...
   */
  score(firstTarget: SingleEntityArgument, firstObjective: string | ObjectiveClass, comparison: 'matches', value: Range): void

  // eslint-disable-next-line max-len
  score(firstTarget: SingleEntityArgument, firstObjective: string | ObjectiveClass, comparison: 'matches' | COMPARISON_OPERATORS, otherTarget: SingleEntityArgument, otherObjective: string | ObjectiveClass): void

  score(firstScore: Score, comparison: 'matches', value: Range): void

  score(firstScore: Score, comparison: 'matches' | COMPARISON_OPERATORS, otherScore: Score): void
  ...
  score(...args: any[]) {
    ...
    this.nestedExecute(['score', ...finalArgs], true)
  }
...
export class ExecuteCommand extends ExecuteCommandPart {
   ...
   */
  positioned(pos: Coordinates): void
   ...
   */
  rotated(rotation: Rotation): void
