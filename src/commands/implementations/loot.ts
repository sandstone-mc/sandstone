...
class LootSourceCommand extends CommandArguments {
   ...
   */
  fish = (lootTable: LootTableArgument, pos: Coordinates, tool: 'mainhand' | 'offhand') => this.finalCommand(['fish', lootTable, coordinatesParser(pos), tool])
   ...
   */
  mine = (pos: Coordinates, tool: 'mainhand' | 'offhand') => this.finalCommand(['mine', coordinatesParser(pos), tool])
}
