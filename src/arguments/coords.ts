...
type AbsoluteOrRelativeVec3<MACRO extends boolean> =
...
type AbsoluteOrRelativeVec2<MACRO extends boolean> =
...
export type Coordinates<MACRO extends boolean> =
...
export type ColumnCoordinates<MACRO extends boolean> =
  | [x: string, z: string]
  | VectorClass<[string, string]>
