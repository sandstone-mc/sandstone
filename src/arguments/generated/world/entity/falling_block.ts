...
export type FallingBlock<S = undefined> = NonNullable<({
  [S in Extract<Extract<BlockState, string>, string>]?: (EntityBase & {
    /**
     * NBT data for the placed block.
     */
    TileEntityData?: ((S extends keyof SymbolBlock
      ? SymbolBlock[S]
      : SymbolBlock<'%unknown'>) & (S extends keyof SymbolBlock ? SymbolBlock[S] : SymbolBlock<'%unknown'>)),
    /**
