...
import type { AreaEffectCloud } from 'sandstone/generated/world/entity/area_effect_cloud'
import type { BlockAttachedEntity, EntityBase } from 'sandstone/generated/world/entity'
import type { BlockDisplay, ItemDisplay, TextDisplay } from 'sandstone/generated/world/entity/display'
import type { EndCrystal } from 'sandstone/generated/world/entity/end_crystal'
import type { EvokerFangs } from 'sandstone/generated/world/entity/evoker_fangs'
import type { ExperienceOrb } from 'sandstone/generated/world/entity/experience_orb'
import type { EyeOfEnder } from 'sandstone/generated/world/entity/eye_of_ender'
import type { FallingBlock } from 'sandstone/generated/world/entity/falling_block'
import type { Interaction } from 'sandstone/generated/world/entity/interaction'
import type { ItemFrame } from 'sandstone/generated/world/entity/item_frame'
import type { Item } from 'sandstone/generated/world/entity/item'
import type { Marker } from 'sandstone/generated/world/entity/marker'
import type {
    ChestMinecart,
    ...
    SpawnerMinecart,
    TntMinecart,
} from 'sandstone/generated/world/entity/minecart'
import type { Allay } from 'sandstone/generated/world/entity/mob/allay'
import type { ArmorStand } from 'sandstone/generated/world/entity/mob/armor_stand'
import type { Bat } from 'sandstone/generated/world/entity/mob/bat'
import type { Bogged } from 'sandstone/generated/world/entity/mob/bogged'
import type { Armadillo } from 'sandstone/generated/world/entity/mob/breedable/armadillo'
import type { Axolotl } from 'sandstone/generated/world/entity/mob/breedable/axolotl'
import type { Bee } from 'sandstone/generated/world/entity/mob/breedable/bee'
import type { Breedable } from 'sandstone/generated/world/entity/mob/breedable'
import type { Chicken } from 'sandstone/generated/world/entity/mob/breedable/chicken'
import type { Cow } from 'sandstone/generated/world/entity/mob/breedable/cow'
import type { Fox } from 'sandstone/generated/world/entity/mob/breedable/fox'
import type { Frog } from 'sandstone/generated/world/entity/mob/breedable/frog'
import type { Goat } from 'sandstone/generated/world/entity/mob/breedable/goat'
import type { Hoglin } from 'sandstone/generated/world/entity/mob/breedable/hoglin'
import type {
    Camel,
    ChestedHorse,
    Horse,
    ...
    SkeletonHorse,
    TraderLlama,
} from 'sandstone/generated/world/entity/mob/breedable/horse'
import type { Mooshroom } from 'sandstone/generated/world/entity/mob/breedable/mooshroom'
import type { Ocelot } from 'sandstone/generated/world/entity/mob/breedable/ocelot'
import type { Panda } from 'sandstone/generated/world/entity/mob/breedable/panda'
import type { PolarBear } from 'sandstone/generated/world/entity/mob/breedable/polar_bear'
import type { Rabbit } from 'sandstone/generated/world/entity/mob/breedable/rabbit'
import type { Pig, Saddled } from 'sandstone/generated/world/entity/mob/breedable/saddled'
import type { Sheep } from 'sandstone/generated/world/entity/mob/breedable/sheep'
import type { Cat, Parrot, Tamable, Wolf } from 'sandstone/generated/world/entity/mob/breedable/tamable'
import type { Turtle } from 'sandstone/generated/world/entity/mob/breedable/turtle'
import type { Villager, WanderingTrader } from 'sandstone/generated/world/entity/mob/breedable/villager'
import type { CopperGolem } from 'sandstone/generated/world/entity/mob/copper_golem'
import type { Creaking } from 'sandstone/generated/world/entity/mob/creaking'
import type { Creeper } from 'sandstone/generated/world/entity/mob/creeper'
import type { Dolphin } from 'sandstone/generated/world/entity/mob/dolphin'
import type { EnderDragon } from 'sandstone/generated/world/entity/mob/ender_dragon'
import type { Enderman } from 'sandstone/generated/world/entity/mob/enderman'
import type { Endermite } from 'sandstone/generated/world/entity/mob/endermite'
import type { Fish, Pufferfish, Salmon, TropicalFish } from 'sandstone/generated/world/entity/mob/fish'
import type { Ghast } from 'sandstone/generated/world/entity/mob/ghast'
import type { GlowSquid } from 'sandstone/generated/world/entity/mob/glow_squid'
import type { IronGolem } from 'sandstone/generated/world/entity/mob/iron_golem'
import type { Mannequin } from 'sandstone/generated/world/entity/mob/mannequin'
import type { MobBase, Squid } from 'sandstone/generated/world/entity/mob'
import type { Phantom } from 'sandstone/generated/world/entity/mob/phantom'
import type { Piglin, PiglinBase } from 'sandstone/generated/world/entity/mob/piglin'
import type { Player } from 'sandstone/generated/world/entity/mob/player'
import type {
    Pillager,
    RaiderBase,
    Ravager,
    Spellcaster,
    Vindicator,
} from 'sandstone/generated/world/entity/mob/raider'
import type { Shulker } from 'sandstone/generated/world/entity/mob/shulker'
import type { Skeleton } from 'sandstone/generated/world/entity/mob/skeleton'
import type { Slime } from 'sandstone/generated/world/entity/mob/slime'
import type { SnowGolem } from 'sandstone/generated/world/entity/mob/snow_golem'
import type { Tadpole } from 'sandstone/generated/world/entity/mob/tadpole'
import type { Vex } from 'sandstone/generated/world/entity/mob/vex'
import type { Warden } from 'sandstone/generated/world/entity/mob/warden'
import type { Wither } from 'sandstone/generated/world/entity/mob/wither'
import type { Zoglin } from 'sandstone/generated/world/entity/mob/zoglin'
import type { Zombie, ZombieVillager } from 'sandstone/generated/world/entity/mob/zombie'
import type { ZombiePigman } from 'sandstone/generated/world/entity/mob/zombified_piglin'
import type { OminousItemSpawner } from 'sandstone/generated/world/entity/ominous_item_spawner'
import type { Painting } from 'sandstone/generated/world/entity/painting'
import type { Arrow, SpectralArrow, Trident } from 'sandstone/generated/world/entity/projectile/arrow'
import type {
    ...
    LargeFireball,
    WitherSkull,
} from 'sandstone/generated/world/entity/projectile/fireball'
import type { FireWorkRocket } from 'sandstone/generated/world/entity/projectile/firework_rocket'
import type { LlamaSpit } from 'sandstone/generated/world/entity/projectile'
import type { ShulkerBullet } from 'sandstone/generated/world/entity/projectile/shulker_bullet'
import type { Potion, ThrowableItem } from 'sandstone/generated/world/entity/projectile/throwable'
import type { Tnt } from 'sandstone/generated/world/entity/tnt'
