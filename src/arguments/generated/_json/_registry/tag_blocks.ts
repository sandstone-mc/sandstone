...
export type JSONTAG_BLOCKS = (
  | NamespacedLiteralUnion<SetType<typeof JSONTAG_BLOCKS_SET>>
  | `minecraft:${SetType<typeof JSONTAG_BLOCKS_SET>}`)

export const JSONTAG_BLOCKS_SET = new Set([
  'acacia_logs',
  'air',
  'all_hanging_signs',
  'all_signs',
