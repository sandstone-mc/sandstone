...
export type JSONSENSOR_TYPES = (
  | NamespacedLiteralUnion<SetType<typeof JSONSENSOR_TYPES_SET>>
  | `minecraft:${SetType<typeof JSONSENSOR_TYPES_SET>}`)

export const JSONSENSOR_TYPES_SET = new Set([
