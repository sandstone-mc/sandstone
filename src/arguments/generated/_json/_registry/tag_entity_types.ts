...
export type JSONTAG_ENTITY_TYPES = (
  | NamespacedLiteralUnion<SetType<typeof JSONTAG_ENTITY_TYPES_SET>>
  | `minecraft:${SetType<typeof JSONTAG_ENTITY_TYPES_SET>}`)

export const JSONTAG_ENTITY_TYPES_SET = new Set([
