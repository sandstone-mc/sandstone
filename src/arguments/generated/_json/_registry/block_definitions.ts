...
export type JSONBLOCK_DEFINITIONS = (
  | NamespacedLiteralUnion<SetType<typeof JSONBLOCK_DEFINITIONS_SET>>
  | `minecraft:${SetType<typeof JSONBLOCK_DEFINITIONS_SET>}`)

export const JSONBLOCK_DEFINITIONS_SET = new Set([
  'acacia_button',
  'acacia_door',
  'acacia_fence',
  'acacia_fence_gate',
