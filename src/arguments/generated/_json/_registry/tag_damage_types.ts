...
export type JSONTAG_DAMAGE_TYPES = (
  | NamespacedLiteralUnion<SetType<typeof JSONTAG_DAMAGE_TYPES_SET>>
  | `minecraft:${SetType<typeof JSONTAG_DAMAGE_TYPES_SET>}`)

export const JSONTAG_DAMAGE_TYPES_SET = new Set([
