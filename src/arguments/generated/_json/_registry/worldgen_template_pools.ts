...
export type JSONWORLDGEN_TEMPLATE_POOLS = (
  | NamespacedLiteralUnion<SetType<typeof JSONWORLDGEN_TEMPLATE_POOLS_SET>>
  | `minecraft:${SetType<typeof JSONWORLDGEN_TEMPLATE_POOLS_SET>}`)

export const JSONWORLDGEN_TEMPLATE_POOLS_SET = new Set([
  'abandoned_camp/camp/bamboo_jungle',
  'abandoned_camp/camp/birch_forest',
  'abandoned_camp/camp/cherry_grove',
  'abandoned_camp/camp/dappled_forest',
  'abandoned_camp/camp/flower_forest',
  'abandoned_camp/camp/forest',
  'abandoned_camp/camp/meadow',
  ...
  'abandoned_camp/camp/pale_garden',
  'abandoned_camp/camp/savanna',
  'abandoned_camp/camp/snowy_taiga',
  'abandoned_camp/camp/sparse_jungle',
  'abandoned_camp/camp/swamp',
  'abandoned_camp/camp/taiga',
  'abandoned_camp/camp/windswept_forest',
  'abandoned_camp/camp/wooded_badlands',
  'abandoned_camp/tent/bamboo_jungle',
  'abandoned_camp/tent/birch_forest',
  'abandoned_camp/tent/cherry_grove',
  'abandoned_camp/tent/dappled_forest',
  'abandoned_camp/tent/flower_forest',
  'abandoned_camp/tent/forest',
  'abandoned_camp/tent/meadow',
  ...
  'abandoned_camp/tent/pale_garden',
  'abandoned_camp/tent/savanna',
  'abandoned_camp/tent/snowy_taiga',
  'abandoned_camp/tent/sparse_jungle',
  'abandoned_camp/tent/swamp',
  'abandoned_camp/tent/taiga',
  'abandoned_camp/tent/windswept_forest',
  'abandoned_camp/tent/wooded_badlands',
  'abandoned_camp/trees/acacia',
  'abandoned_camp/trees/bamboo',
  'abandoned_camp/trees/birch',
  'abandoned_camp/trees/birch_bees',
  'abandoned_camp/trees/cherry',
  'abandoned_camp/trees/cherry_bees',
  'abandoned_camp/trees/fancy_oak',
  'abandoned_camp/trees/fancy_oak_bees',
  'abandoned_camp/trees/jungle',
  'abandoned_camp/trees/mega_jungle',
  'abandoned_camp/trees/mega_pine',
  'abandoned_camp/trees/oak',
  'abandoned_camp/trees/orange_poplar',
  'abandoned_camp/trees/pale_oak',
  'abandoned_camp/trees/pine',
  'abandoned_camp/trees/red_poplar',
  'abandoned_camp/trees/spruce',
  'abandoned_camp/trees/spruce_on_snow',
  'abandoned_camp/trees/super_birch_bees',
  'abandoned_camp/trees/thick_spruce',
  'abandoned_camp/trees/yellow_poplar',
  ...
  'trial_chambers/hallway/fallback',
