...
export type JSONCONTEXT_INT_PROVIDERS = (
  | NamespacedLiteralUnion<SetType<typeof JSONCONTEXT_INT_PROVIDERS_SET>>
  | `minecraft:${SetType<typeof JSONCONTEXT_INT_PROVIDERS_SET>}`)

export const JSONCONTEXT_INT_PROVIDERS_SET = new Set([
