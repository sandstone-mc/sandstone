...
export type JSONTAG_ITEMS = (
  | NamespacedLiteralUnion<SetType<typeof JSONTAG_ITEMS_SET>>
  | `minecraft:${SetType<typeof JSONTAG_ITEMS_SET>}`)

export const JSONTAG_ITEMS_SET = new Set([
  'acacia_logs',
  'anvil',
  'armadillo_food',
  'arrows',
