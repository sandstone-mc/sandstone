...
export type JSONINCOMING_RPC_METHODS = (
  | NamespacedLiteralUnion<SetType<typeof JSONINCOMING_RPC_METHODS_SET>>
  | `minecraft:${SetType<typeof JSONINCOMING_RPC_METHODS_SET>}`)

export const JSONINCOMING_RPC_METHODS_SET = new Set([
  'allowlist',
  'allowlist/add',
  'allowlist/clear',
  'allowlist/remove',
