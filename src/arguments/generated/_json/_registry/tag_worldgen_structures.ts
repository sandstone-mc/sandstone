...
export type JSONTAG_WORLDGEN_STRUCTURES = (
  | NamespacedLiteralUnion<SetType<typeof JSONTAG_WORLDGEN_STRUCTURES_SET>>
  | `minecraft:${SetType<typeof JSONTAG_WORLDGEN_STRUCTURES_SET>}`)

export const JSONTAG_WORLDGEN_STRUCTURES_SET = new Set([
  'abandoned_camp',
  'cats_spawn_as_black',
  'cats_spawn_in',
  'dolphin_located',
