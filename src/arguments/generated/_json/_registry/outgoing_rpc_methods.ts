...
export type JSONOUTGOING_RPC_METHODS = (
  | NamespacedLiteralUnion<SetType<typeof JSONOUTGOING_RPC_METHODS_SET>>
  | `minecraft:${SetType<typeof JSONOUTGOING_RPC_METHODS_SET>}`)

export const JSONOUTGOING_RPC_METHODS_SET = new Set([
