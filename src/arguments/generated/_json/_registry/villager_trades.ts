...
export type JSONVILLAGER_TRADES = (
  | NamespacedLiteralUnion<SetType<typeof JSONVILLAGER_TRADES_SET>>
  | `minecraft:${SetType<typeof JSONVILLAGER_TRADES_SET>}`)

export const JSONVILLAGER_TRADES_SET = new Set([
