...
export type JSONTRIAL_SPAWNERS = (
  | NamespacedLiteralUnion<SetType<typeof JSONTRIAL_SPAWNERS_SET>>
  | `minecraft:${SetType<typeof JSONTRIAL_SPAWNERS_SET>}`)

export const JSONTRIAL_SPAWNERS_SET = new Set([
