...
export type JSONTAG_ENCHANTMENTS = (
  | NamespacedLiteralUnion<SetType<typeof JSONTAG_ENCHANTMENTS_SET>>
  | `minecraft:${SetType<typeof JSONTAG_ENCHANTMENTS_SET>}`)

export const JSONTAG_ENCHANTMENTS_SET = new Set([
  'curse',
  'double_trade_price',
  'exclusive_set/armor',
  'exclusive_set/boots',
