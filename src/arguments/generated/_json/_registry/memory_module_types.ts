...
export type JSONMEMORY_MODULE_TYPES = (
  | NamespacedLiteralUnion<SetType<typeof JSONMEMORY_MODULE_TYPES_SET>>
  | `minecraft:${SetType<typeof JSONMEMORY_MODULE_TYPES_SET>}`)

export const JSONMEMORY_MODULE_TYPES_SET = new Set([
  'admiring_disabled',
  'admiring_item',
  'angry_at',
  'ate_recently',
