...
export type JSONSOUND_EVENTS = (
  | NamespacedLiteralUnion<SetType<typeof JSONSOUND_EVENTS_SET>>
  | `minecraft:${SetType<typeof JSONSOUND_EVENTS_SET>}`)

export const JSONSOUND_EVENTS_SET = new Set([
