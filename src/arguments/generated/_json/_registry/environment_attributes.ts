...
export type JSONENVIRONMENT_ATTRIBUTES = (
  | NamespacedLiteralUnion<SetType<typeof JSONENVIRONMENT_ATTRIBUTES_SET>>
  | `minecraft:${SetType<typeof JSONENVIRONMENT_ATTRIBUTES_SET>}`)

export const JSONENVIRONMENT_ATTRIBUTES_SET = new Set([
