...
export type JSONTAG_WORLDGEN_BIOMES = (
  | NamespacedLiteralUnion<SetType<typeof JSONTAG_WORLDGEN_BIOMES_SET>>
  | `minecraft:${SetType<typeof JSONTAG_WORLDGEN_BIOMES_SET>}`)

export const JSONTAG_WORLDGEN_BIOMES_SET = new Set([
