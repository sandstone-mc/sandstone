...
export type JSONWORLDGEN_PROCESSOR_LISTS = (
  | NamespacedLiteralUnion<SetType<typeof JSONWORLDGEN_PROCESSOR_LISTS_SET>>
  | `minecraft:${SetType<typeof JSONWORLDGEN_PROCESSOR_LISTS_SET>}`)

export const JSONWORLDGEN_PROCESSOR_LISTS_SET = new Set([
