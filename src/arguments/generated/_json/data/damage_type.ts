...
export type JsonDamageEffects = ('hurt' | 'thorns' | 'drowning' | 'burning' | 'poking' | 'freezing')

export type JsonDamageScaling = ('never' | 'always' | 'when_caused_by_living_non_player')

export type JsonDamageType = {
  /**
   ...
   */
  death_message_type?: JsonDeathMessageType,
}

export type JsonDeathMessageType = ('default' | 'fall_variants' | 'intentional_game_design')
