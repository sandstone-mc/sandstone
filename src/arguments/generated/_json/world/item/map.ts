...
export type JsonColorDisplay = (JsonDisplay & {
   ...
   */
  MapColor?: (NBTInt | number),
})

export type JsonDecoration = {
  /**
   * Decoration type.
   *
   * Value:
...
export type JsonFilledMap = (JsonItemBase & {
  /**
   ...
   */
  Decorations?: Array<(JsonDecoration & {
    /**
...
export type JsonIdentifiedDecoration = (JsonDecoration & {
  /**
   * An arbitrary unique string identifying the decoration.
   */
  id: string,
