...
import type { JsonNBTList, NBTByte, NBTInt, NBTIntArray, NBTLong } from 'sandstone'

export type JsonCamel = (JsonHorseBase & {
  /**
   ...
   */
  LastPoseTick?: (NBTLong | number),
})

export type JsonChestedHorse = (JsonHorseBase & {
  /**
...
export type JsonHorse = (JsonHorseBase & {
  /**
   ...
   */
  Variant?: JsonHorseVariantAndMarkings,
})

export type JsonHorseBase = (JsonBreedable & {
  /**
   * Unknown use.
...
export type JsonHorseVariantAndMarkings = (
  | 0
  | 1
  | 2
  | 3
...
export type JsonLlama = (JsonChestedHorse & {
  /**
   ...
   *  - Gray(`3`)
   */
  Variant?: JsonLlamaVariantInt,
})

export type JsonLlamaVariantInt = (0 | 1 | 2 | 3)

export type JsonSkeletonHorse = (JsonHorseBase & {
  /**
   ...
   */
  SkeletonTrapTime?: (NBTInt | number),
})

export type JsonTraderLlama = (JsonLlama & {
  /**
