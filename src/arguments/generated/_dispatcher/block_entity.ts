import type { Banner } from 'sandstone/arguments/generated/world/block/banner.ts'
import type { Beacon } from 'sandstone/arguments/generated/world/block/beacon.ts'
import type { Beehive } from 'sandstone/arguments/generated/world/block/beehive.ts'
import type { BrewingStand } from 'sandstone/arguments/generated/world/block/brewing_stand.ts'
import type { BrushableBlock } from 'sandstone/arguments/generated/world/block/brushable_block.ts'
import type { Campfire } from 'sandstone/arguments/generated/world/block/campfire.ts'
import type { ChiseledBookshelf } from 'sandstone/arguments/generated/world/block/chiseled_bookshelf.ts'
import type { CommandBlock } from 'sandstone/arguments/generated/world/block/command_block.ts'
import type { Comparator } from 'sandstone/arguments/generated/world/block/comparator.ts'
import type { Conduit } from 'sandstone/arguments/generated/world/block/conduit.ts'
import type { Container27, Container9, Hopper, Shelf } from 'sandstone/arguments/generated/world/block/container.ts'
import type { Crafter } from 'sandstone/arguments/generated/world/block/crafter.ts'
import type { CreakingHeart } from 'sandstone/arguments/generated/world/block/creaking_heart.ts'
import type { DecoratedPot } from 'sandstone/arguments/generated/world/block/decorated_pot.ts'
import type { EnchantingTable } from 'sandstone/arguments/generated/world/block/enchanting_table.ts'
import type { EndGateway } from 'sandstone/arguments/generated/world/block/end_gateway.ts'
import type { Furnace } from 'sandstone/arguments/generated/world/block/furnace.ts'
import type { Skull } from 'sandstone/arguments/generated/world/block/head.ts'
import type { Jigsaw } from 'sandstone/arguments/generated/world/block/jigsaw.ts'
...
import type { Sign } from 'sandstone/arguments/generated/world/block/sign.ts'
import type { Spawner, TrialSpawner } from 'sandstone/arguments/generated/world/block/spawner.ts'
import type { StructureBlock } from 'sandstone/arguments/generated/world/block/structure_block.ts'
import type { TestBlock } from 'sandstone/arguments/generated/world/block/test_block.ts'
import type { TestInstanceBlock } from 'sandstone/arguments/generated/world/block/test_instance_block.ts'
import type { Vault } from 'sandstone/arguments/generated/world/block/vault.ts'
