import type { Banner } from 'sandstone/generated/world/block/banner'
import type { Beacon } from 'sandstone/generated/world/block/beacon'
import type { Beehive } from 'sandstone/generated/world/block/beehive'
import type { BrewingStand } from 'sandstone/generated/world/block/brewing_stand'
import type { BrushableBlock } from 'sandstone/generated/world/block/brushable_block'
import type { Campfire } from 'sandstone/generated/world/block/campfire'
import type { ChiseledBookshelf } from 'sandstone/generated/world/block/chiseled_bookshelf'
import type { CommandBlock } from 'sandstone/generated/world/block/command_block'
import type { Comparator } from 'sandstone/generated/world/block/comparator'
import type { Conduit } from 'sandstone/generated/world/block/conduit'
import type { Container27, Container9, Hopper, Shelf } from 'sandstone/generated/world/block/container'
import type { Crafter } from 'sandstone/generated/world/block/crafter'
import type { CreakingHeart } from 'sandstone/generated/world/block/creaking_heart'
import type { DecoratedPot } from 'sandstone/generated/world/block/decorated_pot'
import type { EnchantingTable } from 'sandstone/generated/world/block/enchanting_table'
import type { EndGateway } from 'sandstone/generated/world/block/end_gateway'
import type { Furnace } from 'sandstone/generated/world/block/furnace'
import type { Skull } from 'sandstone/generated/world/block/head'
import type { Jigsaw } from 'sandstone/generated/world/block/jigsaw'
import type { Jukebox } from 'sandstone/generated/world/block/jukebox'
import type { Lectern } from 'sandstone/generated/world/block/lectern'
import type { MovingPiston } from 'sandstone/generated/world/block/moving_piston'
import type { SculkCatalyst } from 'sandstone/generated/world/block/sculk_catalyst'
import type { SculkSensor } from 'sandstone/generated/world/block/sculk_sensor'
import type { SculkShrieker } from 'sandstone/generated/world/block/sculk_shrieker'
import type { Sign } from 'sandstone/generated/world/block/sign'
import type { Spawner, TrialSpawner } from 'sandstone/generated/world/block/spawner'
import type { StructureBlock } from 'sandstone/generated/world/block/structure_block'
import type { TestBlock } from 'sandstone/generated/world/block/test_block'
import type { TestInstanceBlock } from 'sandstone/generated/world/block/test_instance_block'
import type { Vault } from 'sandstone/generated/world/block/vault'
